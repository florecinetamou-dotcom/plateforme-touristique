...
<<<<<<< HEAD
        ...
        <!-- ✅ AJOUT : Menu Newsletter -->
        <a href="/admin/newsletter" class="nav-item <?= isActive('/admin/newsletter') ?>">
            <span class="nav-icon">📧</span> Newsletter
            <?php if (($badges['nb_newsletter'] ?? 0) > 0): ?>
                <span class="nav-badge" style="background:#008751;"><?= $badges['nb_newsletter'] ?></span>
            <?php endif; ?>
=======
