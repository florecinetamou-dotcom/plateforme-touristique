...
<<<<<<< HEAD
    .heb-page { background-color: #f0f7f3; min-height: 100vh; font-family: 'Poppins', sans-serif; }
    .heb-card { border: none; border-radius: 20px; transition: transform 0.3s ease, box-shadow 0.3s ease; background: #fff; overflow: hidden; height: 100%; box-shadow: 0 5px 15px rgba(0,0,0,0.05); position: relative; }
    .heb-card:hover { transform: translateY(-8px); box-shadow: 0 15px 30px rgba(0,135,81,0.15) !important; }
    .heb-card-img-wrap { position: relative; height: 200px; overflow: hidden; }
    .heb-card-img-wrap img { width: 100%; height: 100%; object-fit: cover; transition: transform 0.5s ease; }
    .heb-card:hover .heb-card-img-wrap img { transform: scale(1.1); }
    .status-badge { position: absolute; top: 15px; right: 15px; padding: 6px 14px; border-radius: 50px; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 4px 10px rgba(0,0,0,0.15); z-index: 2; backdrop-filter: blur(4px); }
    .status-approuve { background: var(--benin-green); color: white; }
    .status-en_attente { background: var(--benin-yellow); color: #000; }
    .status-refuse { background: #dc3545; color: white; }
    .heb-price { font-size: 1.3rem; font-weight: 800; color: var(--benin-green); line-height: 1; }
    .heb-price small { font-size: 0.7rem; font-weight: 400; color: #888; }
    .btn-benin { background: var(--benin-green); color: white; border: none; border-radius: 12px; padding: 10px 24px; font-weight: 600; font-size: 0.9rem; transition: all 0.3s; box-shadow: 0 4px 10px rgba(0,135,81,0.2); }
    .btn-benin:hover { background: #006b40; color: white; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(0,135,81,0.3); }
    .btn-action { border-radius: 10px; padding: 8px 12px; font-size: 0.85rem; font-weight: 600; transition: all 0.2s; display: inline-flex; align-items: center; justify-content: center; gap: 6px; border: none; }
    .btn-action-primary { background: var(--benin-green-light); color: var(--benin-green); }
    .btn-action-primary:hover { background: var(--benin-green); color: white; }
    .btn-action-danger { background: rgba(220, 53, 69, 0.1); color: #dc3545; }
    .btn-action-danger:hover { background: #dc3545; color: white; }
    .page-title { font-size: 1.8rem; font-weight: 700; color: #1e293b; margin: 0; position: relative; display: inline-block; }
    .page-title::after { content: ''; position: absolute; bottom: -8px; left: 0; width: 60px; height: 4px; background: var(--benin-gradient); border-radius: 4px; }
    .empty-state { text-align: center; padding: 60px 40px; background: white; border-radius: 24px; border: 2px dashed rgba(0,135,81,0.2); box-shadow: 0 10px 30px rgba(0,0,0,0.03); }
    .info-tooltip { position: absolute; top: 15px; left: 15px; background: rgba(255,255,255,0.9); border-radius: 50px; padding: 4px 12px; font-size: 0.7rem; font-weight: 600; color: #64748b; box-shadow: 0 2px 8px rgba(0,0,0,0.1); backdrop-filter: blur(4px); z-index: 2; display: flex; align-items: center; gap: 5px; }
=======
        ...
        <div class="col-lg-9 col-md-8">
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-5">
                <div>
                    ...
                    <p class="text-muted small mt-3 mb-0">Gérez vos biens et suivez leur statut de validation</p>
                </div>
            </div>
...
<<<<<<< HEAD
                                    <?php if ($heb->statut === 'en_attente'): ?>
                                        <div class="info-tooltip">
                                            <i class="fas fa-info-circle"></i> En attente de validation
                                        </div>
                                    <?php endif; ?>
                                </div>
...
<<<<<<< HEAD
                                    ...
                                    <div class="d-flex gap-2 mt-3">
                                        ...
                                        <form method="POST" action="/hebergeur/hebergements/delete/<?= $heb->id ?>"
                                              onsubmit="return confirm('Supprimer cet hébergement ? Action irréversible.')"
=======
...
<<<<<<< HEAD
                    <p class="text-muted mb-4">Commencez par ajouter votre premier hébergement.</p>
                    <!-- ✅ URL corrigée : /create au lieu de /ajouter -->
                    <a href="/hebergeur/hebergements/create" class="btn-benin">
=======
