...
.btn-submit:hover {
    ...
    box-shadow: 0 5px 15px rgba(30, 60, 44, 0.4);
}
            ...
            <div class="col-lg-8">
                <div class="card-edit">
                    <div class="card-header-edit">
                        <h2><i class="fas fa-edit me-2"></i>Modifier mon profil hébergeur</h2>
                    </div>
                    <div class="card-body-edit">
                        <form action="/hebergeur/profil/edit" method="POST" enctype="multipart/form-data">
                            <div class="avatar-preview">
                                <?php if (!empty($user->avatar_url)): ?>
                                    <img src="<?= htmlspecialchars($user->avatar_url) ?>" alt="Avatar" id="avatarPreview">
                                <?php else: ?>
                                    <img src="https://ui-avatars.com/api/?name=<?= urlencode($user->prenom . '+' . $user->nom) ?>&background=1e3c2c&color=fff&size=120" alt="Avatar" id="avatarPreview">
                                <?php endif; ?>
                                <div class="mt-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-edit" name="prenom" value="<?= htmlspecialchars($user->prenom) ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">Nom *</label>
                                        <input type="text" class="form-control form-control-edit" name="nom" value="<?= htmlspecialchars($user->nom) ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control form-control-edit" name="telephone" value="<?= htmlspecialchars($user->telephone ?? '') ?>">
                            </div>
                            
                            <div class="form-group">
                                <label class="form-label">Langue préférée</label>
                                <select class="form-control form-control-edit" name="langue">
                            ...
                            <div class="d-flex gap-2 justify-content-end">
                                <a href="/hebergeur/profil" class="btn btn-cancel">Annuler</a>
