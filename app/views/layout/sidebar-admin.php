...
<<<<<<< HEAD
    ...
    [
        ...
        'badge_key' => 'nb_newsletter',  // Pour afficher le nombre d'inscrits
    ],
    [
...
<<<<<<< HEAD
/* Badge spécial newsletter */
.link-badge.newsletter {
    background: #008751;
}
...
<<<<<<< HEAD
                <span class="link-badge <?= $item['badge_key'] === 'nb_newsletter' ? 'newsletter' : '' ?>">
                    <?= $badge_count ?>
                </span>
=======
