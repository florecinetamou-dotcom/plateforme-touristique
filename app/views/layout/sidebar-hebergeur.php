...
<div class="heb-sidebar">
    ...
    <div class="heb-sidebar-profile">
        ...
        <div>
            ...
            <div class="heb-sidebar-role"><i class="fas fa-circle me-1" style="font-size:7px; color:#22c55e;"></i>Hébergeur actif</div>
        </div>
    </div>
    ...
    <nav class="heb-nav">
        ...
        <a href="/hebergeur/profil"
           class="heb-nav-item <?= isHebergeurActive('/hebergeur/profil', $current_page) ?>">
...
.heb-back-site:hover { color: #008751; }
</style>