...
$user_name = $user['name'] ?? 'Mon compte';
...
<<<<<<< HEAD
                                <?= strtoupper(substr($user_prenom ?: $user_name, 0, 1)) ?>
                            </div>
                            <span class="user-name d-none d-xl-inline"><?= htmlspecialchars($user_prenom ?: $user_name) ?></span>
=======
...
<<<<<<< HEAD
#mainNavbar.scrolled { box-shadow: 0 4px 24px rgba(0,0,0,0.08); }
...
.brand-text { font-size: 1.2rem; font-weight: 700; color: #1a1a2e; letter-spacing: -0.3px; }
.brand-accent { color: #008751; }

.nav-link {
    color: #444 !important; font-size: 0.88rem; font-weight: 500;
    padding: 8px 14px !important; border-radius: 8px;
    transition: all 0.2s ease; position: relative;
}
.nav-link:hover { color: #008751 !important; background: rgba(0,135,81,0.07); }
.nav-link.active { color: #008751 !important; background: rgba(0,135,81,0.1); font-weight: 600; }
.nav-link.active::after {
    content: ''; position: absolute; bottom: 4px; left: 50%;
    transform: translateX(-50%); width: 18px; height: 2.5px;
    background: linear-gradient(90deg, #008751, #FFD600); border-radius: 2px;
}

.btn-nav-outline {
    border: 1.5px solid #008751; color: #008751; background: transparent;
    border-radius: 50px; padding: 7px 18px; font-size: 0.85rem; font-weight: 500;
    transition: all 0.25s ease;
}
.btn-nav-outline:hover { background: #008751; color: white; box-shadow: 0 4px 12px rgba(0,135,81,0.25); }
.btn-nav-solid {
    background: linear-gradient(135deg, #008751, #00a862); color: white;
...
.btn-nav-solid:hover { color: white; transform: translateY(-1px); box-shadow: 0 6px 16px rgba(0,135,81,0.35); filter: brightness(1.05); }

.btn-user {
    background: transparent; border: 1.5px solid rgba(0,135,81,0.25);
    border-radius: 50px; padding: 5px 14px 5px 6px;
    display: flex; align-items: center; gap: 8px;
    transition: all 0.2s ease; color: #333; font-size: 0.85rem; font-weight: 500;
}
.btn-user:hover, .btn-user:focus { background: rgba(0,135,81,0.06); border-color: #008751; color: #008751; box-shadow: none; }
...
.user-dropdown {
    border: none; border-radius: 14px; padding: 8px; min-width: 240px;
    box-shadow: 0 10px 40px rgba(0,0,0,0.12) !important;
    margin-top: 8px !important; animation: dropdownFadeIn 0.2s ease;
=======
#mainNavbar.scrolled {
...
<<<<<<< HEAD
.dropdown-header { padding: 6px 10px 10px; color: inherit; }
.dropdown-divider { border-color: #f0f0f0; }
.dropdown-item {
    border-radius: 8px; padding: 9px 14px; font-size: 0.875rem;
    color: #333; transition: all 0.15s ease; display: flex; align-items: center;
}
.dropdown-item i { color: #008751; width: 18px; text-align: center; }
.dropdown-item:hover { background: rgba(0,135,81,0.08); color: #008751; transform: translateX(3px); }
.dropdown-item.item-special { 
    background: linear-gradient(135deg, #00875110 0%, #FFD60010 100%);
    border-left: 3px solid #008751;
    font-weight: 500;
}
.dropdown-item.item-special:hover { background: linear-gradient(135deg, #00875120 0%, #FFD60020 100%); }
=======
.dropdown-header {
...
<<<<<<< HEAD
.navbar-toggler { border: none; padding: 6px; display: flex; flex-direction: column; gap: 5px; background: transparent; }
.navbar-toggler:focus { box-shadow: none; }
.toggler-bar { display: block; width: 24px; height: 2px; background: #008751; border-radius: 2px; transition: all 0.3s ease; }

@media (max-width: 991px) {
    .navbar-collapse { background: white; border-radius: 14px; padding: 12px; margin-top: 10px; box-shadow: 0 8px 30px rgba(0,0,0,0.1); }
    .nav-link { padding: 10px 14px !important; }
    .navbar-nav { gap: 2px !important; margin-bottom: 12px; }
    .d-flex.align-items-center.gap-2 { flex-direction: column; width: 100%; }
    .btn-nav-outline, .btn-nav-solid { width: 100%; text-align: center; justify-content: center; }
=======
/* ===== TOGGLER MOBILE ===== */
.navbar-toggler {
    border: none;
